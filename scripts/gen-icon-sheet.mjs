...
const GROUPS = [
  {
    ...
    note: 'line style (converts to filled in 2b-ii)',
    icons: [
      ['strike', 'line', 1.8, '<path d="M12 3 L12 13.5"/><path d="M8.5 13.5 H15.5"/><path d="M12 13.5 V18.5"/><circle cx="12" cy="20" r="1.3" fill="currentColor" stroke="none"/>'],
      ['power_strike', 'line', 1.8, '<path d="M6 12 L12 6.5 L18 12"/><path d="M6 17.5 L12 12 L18 17.5"/>'],
      ['battle_cry', 'line', 1.8, '<path d="M4 10 H8 L14 6.5 V17.5 L8 14 H4 Z"/><path d="M17 9 A4 4 0 0 1 17 15"/>'],
      ['execute', 'line', 1.8, '<path d="M6 11 A6 6 0 0 1 18 11 V14 Q18 16 16 16 V18 H8 V16 Q6 16 6 14 Z"/><circle cx="9.8" cy="11" r="1.4" fill="currentColor" stroke="none"/><circle cx="14.2" cy="11" r="1.4" fill="currentColor" stroke="none"/><path d="M12 13 L11 14.5 H13 Z" fill="currentColor" stroke="none"/>'],
      ['quick_slash', 'line', 1.8, '<path d="M5 17 Q12 5 19 9"/><path d="M17 6 L19 9 L16 10"/>'],
      ['twin_fangs', 'line', 1.8, '<path d="M7 6 H17"/><path d="M8.5 6 L10.5 15 L12.5 6"/><path d="M13 6 L15 15 L17 6"/>'],
      ['hemorrhage', 'line', 1.8, '<path d="M12 4 C12 4 6 11 6 15 A6 6 0 0 0 18 15 C18 11 12 4 12 4 Z"/>'],
      ['evasive_leap', 'line', 1.8, '<path d="M17.5 8.5 A5.2 5.2 0 1 0 18 13.5"/><path d="M18 13.5 L20 12 M18 13.5 L18.8 15.6"/>'],
      ['arcane_bolt', 'line', 1.8, '<path d="M12 4 C12.5 9 13 10.5 20 12 C13 13.5 12.5 15 12 20 C11.5 15 11 13.5 4 12 C11 10.5 11.5 9 12 4 Z" fill="currentColor" stroke="none"/>'],
      ['fireball', 'line', 1.8, '<path d="M12 3 C15 8 17 9 16 14 A4.5 4.5 0 1 1 8 14 C7.6 11 9 10 9.6 9 C10 11 11 11.4 11.4 11 C12.4 10 11 6 12 3 Z"/>'],
      ...
      ['immolate', 'line', 1.8, '<path d="M12 2 C16 8 18 10 16.5 15 A5 5 0 1 1 7.5 15 C7 12 8 10.5 9 9.5 C9.5 12 11 12 11 11 C12 9 10.5 5 12 2 Z"/><path d="M12 12.5 C13 14 13.4 15.4 12 17.2 C10.8 15.6 11 14.2 12 12.5 Z" fill="currentColor" stroke="none"/>'],
      ['arcane_surge', 'line', 1.8, '<path d="M12 3 V7 M12 17 V21 M3 12 H7 M17 12 H21 M6 6 L8.8 8.8 M15.2 15.2 L18 18 M18 6 L15.2 8.8 M8.8 15.2 L6 18"/><circle cx="12" cy="12" r="2.2" fill="currentColor" stroke="none"/>'],
    ],
  },
  {
    title: 'Item Slots',
...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  .tile { background:var(--tile); border:1px solid var(--line); border-radius:12px; padding:16px 10px 10px; display:flex; flex-direction:column; align-items:center; gap:12px; min-height:104px; justify-content:space-between; }
  .glyph { display:flex; align-items:center; justify-content:center; height:76px; color:var(--tint); }
  .glyph svg { width:var(--icon-size); height:var(--icon-size); display:block; }
  .tile figcaption { font-family:ui-monospace,Menlo,monospace; font-size:11px; color:var(--ink-soft); text-align:center; word-break:break-word; line-height:1.3; }
  footer { padding:30px 0 60px; }
  footer p { font-family:ui-monospace,Menlo,monospace; font-size:12px; color:var(--ink-faint); margin:0; }
  @media (max-width:560px) { .grid { grid-template-columns:repeat(auto-fill,minmax(92px,1fr)); } input[type="range"]{ width:130px; } }
</style>
</head>
<body>
<header>
